      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 bg-white p-3 rounded-xl border border-gray-200 shadow-sm">
        <div>
          <h1 className="text-base font-bold text-slate-900 tracking-tight flex items-center gap-2">
            <Search className="w-4 h-4 text-indigo-600" /> General Ledger
          </h1>
          <p className="text-[10px] text-slate-500 mt-0.5">
            Posting-level register of all journal lines for {currentEntity?.name || 'Active Entity'} (IAS 1, IFRS-compliant).
          </p>
        </div>
