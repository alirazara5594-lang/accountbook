        ...
        <div className="overlay animate-in fade-in duration-200">
          <div className="w-full max-w-4xl bg-[var(--color-surface)] border border-[var(--color-border)] rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <div className="flex items-center gap-2 px-6 pt-3 border-b border-[var(--color-border)] bg-[var(--color-surface)]">
              ...
              >
                <Users className="w-3.5 h-3.5" /> 1. Customer & Delivery
              </button>
              ...
              >
                <Coins className="w-3.5 h-3.5" /> 2. Items & Quantities ({lines.length})
              </button>
              ...
              >
                <FileText className="w-3.5 h-3.5" /> 3. Terms & Confirmation
              </button>
            </div>
            ...
            <div className="px-6 py-3.5 border-t border-[var(--color-border)] bg-[var(--color-surface-muted)]/50 flex items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                {modalTab !== 'summary' ? (
                  ...
                  >
                    <span>Next: {modalTab === 'details' ? 'Order Lines' : 'Terms & Confirmation'}</span>
                  ...
                  <button
                    type="button"
                    onClick={handleSave}
                    className="primary h-8.5 px-4.5 rounded-lg text-xs font-semibold shadow-xs flex items-center gap-1.5 bg-blue-600 hover:bg-blue-700 text-white"
                  >
