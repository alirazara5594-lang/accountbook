    ...
    <div className="animate-fade-in space-y-6">
      <div className="flex justify-between items-center mb-8">
        ...
        <div className="flex gap-4">
          ...
          <button onClick={() => setIsGrnModalOpen(true)} className="px-5 py-2.5 bg-green-600 hover:bg-green-700 text-white text-sm font-medium rounded-xl shadow-sm shadow-green-600/20 transition-all active:scale-95">
            + Receive Goods (GRN)
          </button>
        </div>
      </div>
